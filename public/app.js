...
const marker = L.marker([48.87007, 2.346453]).addTo(map).bindPopup('<pl><b>The Hoxton, Paris</b></pl>').openPopup()
...
const polygon = L.polygon(latlngs, {color: "blue", fill: false}).addTo(map)
